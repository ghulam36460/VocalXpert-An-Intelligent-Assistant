...
class RPSGame(QWidget):
    ...
    def _setup_ui(self):
        ...
        score_layout.setContentsMargins(SPACING["xl"], SPACING["lg"],
        ...
        self.user_score_label.setFont(
            QFont(FONTS["family"], 48, FONTS["weight_bold"]))
