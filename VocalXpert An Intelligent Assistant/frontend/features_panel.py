...
class FeaturesPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        info_label.setFont(QFont(FONTS["family"], FONTS["size_lg"], FONTS["weight_semibold"]))
        ...
        productivity_label.setFont(QFont(FONTS["family"], FONTS["size_lg"], FONTS["weight_semibold"]))
        ...
        media_label.setFont(QFont(FONTS["family"], FONTS["size_lg"], FONTS["weight_semibold"]))
        ...
        system_label.setFont(QFont(FONTS["family"], FONTS["size_lg"], FONTS["weight_semibold"]))
        ...
        apps_label.setFont(QFont(FONTS["family"], FONTS["size_lg"], FONTS["weight_semibold"]))
    ...
    def _create_header(self) -> QWidget:
        ...
        subtitle = QLabel("Quick access to all VocalXpert capabilities - click any card or use voice commands")
    ...
    def _create_weather_card(self) -> Card:
        ...
        title.setFont(QFont(FONTS["family"], FONTS["size_lg"], FONTS["weight_semibold"]))
    ...
    def _create_info_grid(self) -> QWidget:
        ...
        features = [
            ...
            ("📚", "Dictionary", "Word definitions", "dictionary meaning of word"),
    ...
    def _create_media_grid(self) -> QWidget:
        ...
        features = [
            ...
            ("✊", "Rock Paper Scissors", "Play RPS", "play rock paper scissors"),
