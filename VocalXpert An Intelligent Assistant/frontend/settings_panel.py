...
from PySide6.QtWidgets import (
    ...
    QLabel, QFrame, QComboBox, QSlider, QGroupBox,
...
class SettingsPanel(QWidget):
    ...
    def _create_appearance_section(self) -> Card:
        ...
        self.dark_mode_toggle.toggled.connect(
            lambda checked: self.theme_changed.emit("dark" if checked else "light")
        )
        ...
        self.accent_combo.addItems(["Indigo", "Purple", "Blue", "Green", "Pink"])
    ...
    def _create_web_section(self) -> Card:
        ...
        web_desc = QLabel("Enable advanced web features (Wikipedia, weather, news, YouTube, etc.)")
    ...
    def load_settings(self, settings: dict):
        ...
        if "web_scraping_enabled" in settings:
            self.web_scraping_toggle.setChecked(settings["web_scraping_enabled"])
